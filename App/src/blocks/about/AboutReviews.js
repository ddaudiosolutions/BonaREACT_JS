...
class AboutReviews extends Component {
  ...
  componentDidMount() {
    window.location.pathname.includes("about-us")
      ...
      : this.setState({ pageAbout: false });

    var swiperAdvReviewsThumbs = new Swiper(
      ".adv-slider-reviews .adv-swiper-container.reviews-thumbs",
      {
        // ADV swiper
  ...
  render() {
    return (
      <div
        id="testimonials"
        className={
          "block spacer p-top-xl " + (this.state.pageAbout ? " " : "bg-gray-light p-bottom-xl")
        }
      >
              ...
              <div className="adv-swiper-container reviews-thumbs">
                <div className="adv-swiper-wrapper reviews-thumbs-items">
                  <div
                    ...
                    data-reviews-name="Leon Melendez"
                  ...
                  <div
                    onClick={(e) => this.handleClick(e)}
                    className="adv-swiper-slide reviews-thumbs-item"
                    data-reviews-name="Elena Quintero"
                    data-reviews-position="CEO at Company"
                  >
